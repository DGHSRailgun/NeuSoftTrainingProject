...
CREATE TABLE `brd_brand` (
  ...
  `NAME_CN` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATED_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATION_DATE` timestamp NULL DEFAULT NULL,
  `LAST_UPDATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `LAST_UPDATE_DATE` timestamp NULL DEFAULT NULL,
  `CALL_CNT` int(11) DEFAULT NULL,
  `REMARK` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STS_CD` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`BRD_ID`) USING BTREE,
  KEY `MAN_ID` (`MAN_ID`) USING BTREE
...
CREATE TABLE `cdm_code_master` (
  ...
  `CODE_TYPE` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `DESCRIPTION` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `TYPE_CD` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CODE_VAL` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `dsr_dropshipper` (
  ...
  `CALL_CNT` int(11) DEFAULT NULL,
  `REMARK` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STS_CD` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0',
...
CREATE TABLE `goa_government_area` (
  ...
  `STATE_SHORTHAND` varchar(10) DEFAULT NULL,
...
CREATE TABLE `img_image` (
  ...
  `URI` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `TYPE_CD` char(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ENTITY_ID` int(11) DEFAULT NULL,
  `ENTITY_CD` varchar(3) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `SEQ_NO` int(11) DEFAULT NULL,
  `CREATED_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATION_DATE` timestamp NULL DEFAULT NULL,
  `LAST_UPDATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `img_image1` (
  ...
  `TYPE_CD` char(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ENTITY_ID` int(11) DEFAULT NULL,
  `ENTITY_CD` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `SEQ_NO` int(11) DEFAULT NULL,
  `CREATED_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATION_DATE` timestamp NULL DEFAULT NULL,
  `LAST_UPDATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `man_manufacturer` (
  ...
  `NAME_EN` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `NAME_CN` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `GMC_REPORT_TYPE` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `GMC_REPORT_URL` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `ofp_offer_price` (
  ...
  `MAN_ID` int(11) DEFAULT NULL,
  `EFFETIVE_START_DATE` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `par_parameter` (
  ...
  `PARAM_CD` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `PARAM_VALUE` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `pck_package_info` (
  ...
  `REMARK` varchar(50) DEFAULT NULL,
  `STS_CD` char(1) DEFAULT NULL,
  `HEAVY_CARGO` varchar(2) DEFAULT NULL,
...
CREATE TABLE `pdn_product_descrition1` (
  ...
  `PRO_ID` int(11) DEFAULT NULL,
  `TYPE_CD` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `DESCRITION` longtext CHARACTER SET utf8 COLLATE utf8_general_ci,
  `CREATED_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATION_DATE` timestamp NULL DEFAULT NULL,
  `LAST_UPDATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `LAST_UPDATE_DATE` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `prc_product_category` (
  ...
  `REMARK` varchar(50) DEFAULT NULL,
  `STS_CD` char(1) DEFAULT NULL,
  `PLATEFORM_TYPE` varchar(2) DEFAULT NULL,
  PRIMARY KEY (`PRC_ID`)
...
CREATE TABLE `pro_product` (
  ...
  `SKU_CD` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `BRD_ID` int(11) DEFAULT NULL,
  `MAN_ID` int(11) DEFAULT NULL,
  `TITLE` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `UPC` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `EAN` varchar(13) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `MODEL` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `WARRANTY_DAY` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `KEY_WORDS` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `WARRANTY` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  `TIME_UNIT` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `sal_sales_order_line_item` (
  ...
  `REMARK` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STS_CD` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `SAO_ID` int(11) DEFAULT NULL,
  `PRO_ID` int(11) DEFAULT NULL,
  `QTY` int(11) DEFAULT NULL,
  `PRICE` decimal(8,2) DEFAULT NULL,
  `SOL_ID` int(11) DEFAULT NULL,
  `TRACKING_NO` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `WSP_NAME` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `sao_sales_order` (
  ...
  `TRACK_NO_DATE` timestamp NULL DEFAULT NULL,
  `FULFILLMENT_DATE` timestamp NULL DEFAULT NULL,
  `SETTLEMENT_DATE` timestamp NULL DEFAULT NULL,
  `PRODUCT_AMOUNT` decimal(8,2) DEFAULT NULL,
  `FREIGHT_COST` decimal(8,2) DEFAULT NULL,
  `HANDLING_FEE` decimal(8,2) DEFAULT NULL,
  `CUSTOMER_REMARK` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ORDER_NO` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ORDER_STS` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `REFUND_STS` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `DELIVERY_STS` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STO_ID` int(11) DEFAULT NULL,
  `LAST_FREIGHT_COST` decimal(8,2) DEFAULT NULL,
  `CANCLE_TIME` timestamp NULL DEFAULT NULL,
  `AUTO_PAY_STATUS` char(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `BUYER_CHECKOUT_MESSAGE` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  `AUTO_PAY_TIME` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `sao_sales_order` VALUES (1, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:42', 1, '1', '1', 1, 1, '2020-07-08 09:07:50', '2020-07-08 09:07:52', '2020-07-08 09:08:01', '2020-07-08 09:08:04', '2020-07-08 09:08:06', '2020-07-08 09:08:10', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingPayment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:08:28', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (2, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:42', 1, '1', '1', 1, 1, '2020-07-08 09:07:50', '2020-07-08 09:07:52', '2020-07-08 09:08:01', '2020-07-08 09:08:04', '2020-07-08 09:08:06', '2020-07-08 09:08:10', 1222.00, 1.00, 1.00, '1', '1', 'SHIPPED', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:08:28', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (3, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:42', 1, '1', '1', 1, 1, '2020-07-08 09:07:50', '2020-07-08 09:07:52', '2020-07-08 09:08:01', '2020-07-08 09:08:04', '2020-07-08 09:08:06', '2020-07-08 09:08:10', 1222.00, 1.00, 1.00, '1', '1', 'SHIPPED', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:08:28', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (4, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:42', 1, '1', '1', 1, 1, '2020-07-08 09:07:50', '2020-07-08 09:07:52', '2020-07-08 09:08:01', '2020-07-08 09:08:04', '2020-07-08 09:08:06', '2020-07-08 09:08:10', 1222.00, 1.00, 1.00, '1', '1', 'Complete', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:08:28', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (5, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:42', 1, '1', '1', 1, 1, '2020-07-08 09:07:50', '2020-07-08 09:07:52', '2020-07-08 09:08:01', '2020-07-08 09:08:04', '2020-07-08 09:08:06', '2020-07-08 09:08:10', 1222.00, 1.00, 1.00, '1', '1', 'Canceled', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:08:28', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (6, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingPayment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (7, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (8, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (9, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (10, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (11, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (12, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (13, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (14, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'SHIPPED', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (15, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (16, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (17, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (18, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (19, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (20, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'Canceled', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (21, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (22, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (23, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (24, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (25, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (26, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (27, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (28, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'AwaitingShipment', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (29, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'Canceled', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (30, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'Canceled', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (31, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'Canceled', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (32, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'Canceled', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (33, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'Canceled', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (34, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'Canceled', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
INSERT INTO `sao_sales_order` VALUES (35, 's', '2020-07-08 09:07:38', 's', '2020-07-08 09:07:38', 1, '1', '1', 1, 1, '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', '2020-07-08 09:07:38', 1222.00, 1.00, 1.00, '1', '1', 'Canceled', 'OPEN', 'SYNC', 1, 1.00, '2020-07-08 09:07:38', '0', '1', '1');
COMMIT;
...
CREATE TABLE `sdi_store_dropship_item` (
  ...
  `PRO_ID` int(11) DEFAULT NULL,
  `STR_ID` int(11) DEFAULT NULL,
  `STORE_RETENTION` int(11) DEFAULT NULL,
  `DROPSHIP_PRICE` decimal(10,2) DEFAULT NULL,
  `DROPSHIP_STATUS` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATED_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATION_DATE` timestamp NULL DEFAULT NULL,
  `LAST_UPDATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CALL_CNT` int(11) DEFAULT NULL,
  ...
  `REMARK` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STS_CD` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `SHELF_STOCK` int(11) DEFAULT NULL,
  `PREFER_DATE` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `sha_shipping_address` (
  ...
  `REMARK` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STS_CD` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `FAMILY_NAME` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `GIVEN_NAME` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `COUNTRY_NAME` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `COUNTRY_ISO_CD` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STATE_OR_PROVINCE_NAME` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STATE_OR_PROVINCE_CD` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CITY_NAME` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ADDRESS_LINE1` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ADDRESS_LINE2` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ADDRESS_LINE3` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `POSTAL_CD` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CONTACT_PHONE_NO` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `EMAIL` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STO_ID` int(11) DEFAULT NULL,
  `CARRIER_NAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `sol_store_order_line_item` (
  ...
  `ORDER_ITEM_ID` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STO_ID` int(11) DEFAULT NULL,
  `SALES_PRICE` decimal(8,2) DEFAULT NULL,
  `QTY` int(11) DEFAULT NULL,
  `SKU_NO` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATED_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATION_DATE` timestamp NULL DEFAULT NULL,
  `LAST_UPDATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `LAST_UPDATE_DATE` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `spv_specific_attribute_value` (
  ...
  PRIMARY KEY (`SPV_ID`),
  KEY `SPA_ID` (`SPA_ID`),
  CONSTRAINT `spv_specific_attribute_value_ibfk_1` FOREIGN KEY (`SPA_ID`) REFERENCES `spa_specific_attribute` (`spa_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `sto_store_order` (
  ...
  `STR_ID` int(11) DEFAULT NULL,
  `ORDER_ID` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ORDER_CREATED_TIME` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `PAID_TIME` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `LAST_MODIFIED_TIME` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATED_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATION_DATE` timestamp NULL DEFAULT NULL,
  `LAST_UPDATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `LAST_UPDATE_DATE` timestamp NULL DEFAULT NULL,
  ...
  `REMARK` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STS_CD` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `PLATEFORM_TYPE` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CANCEL_COMPLETE_DATE` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `str_store` (
  ...
  `DSR_ID` int(11) DEFAULT NULL,
  `PLATAEFORM_TYPE` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STORE_NAME` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STORE_STS_CD` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATED_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATION_DATE` timestamp NULL DEFAULT NULL,
  `LAST_UPDATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `LAST_UPDATE_DATE` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `sys_menu` (
  ...
  `MENU_HIDDEN` int(1) DEFAULT NULL,
  PRIMARY KEY (`MENU_ID`)
...
) ENGINE=InnoDB AUTO_INCREMENT=374 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `sys_role_user_table` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=325 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES ('1', 'asdf', '$2a$10$1H81ddXs9x/KqYC3IA.kBO7hFac5KXHz1Bgwt49GZbwvjXkXbLFTq', 'Kevin', NULL, '3', NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, 1);
...
INSERT INTO `sys_user` VALUES ('20', 'admin', '$2a$10$1H81ddXs9x/KqYC3IA.kBO7hFac5KXHz1Bgwt49GZbwvjXkXbLFTq', 'admin', 'w', '1', 'e', 'r', '1', 'string', 'string', 'string', 'string', 'string', 1);
COMMIT;
...
CREATE TABLE `ull_user_login_logout_log` (
  ...
  `USI_ID` varchar(32) DEFAULT NULL,
  `TOKEN` varchar(45) DEFAULT NULL,
  `TERMINAL_TYPE` varchar(2) DEFAULT NULL,
  `OPERATING_TYPE` varchar(2) DEFAULT NULL,
  `OPERATING_DATE` timestamp NULL DEFAULT NULL,
  `CREATED_BY` varchar(20) DEFAULT NULL,
  `CREATION_DATE` timestamp NULL DEFAULT NULL,
  `LAST_UPDATE_BY` varchar(20) DEFAULT NULL,
  `LAST_UPDATE_DATE` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `waa_wallet_account1` (
  ...
  `ACTIVE_TIME` datetime DEFAULT NULL,
  `IS_ACTIVE` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `STATUS` tinyint(2) DEFAULT NULL,
  `CREATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATE_TIME` timestamp NULL DEFAULT NULL,
  `LAST_UPDATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `LAST_UPDATE_TIME` timestamp NULL DEFAULT NULL,
  `ACCOUNT_TYPE` int(11) DEFAULT NULL,
  `HOLD_ORDER_TIME` char(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `AUTO_PAY_STATUS` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `waa_wallet_account1` VALUES (1, 'asdf', NULL, '123', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `waf_wallet_account_fund` (
  `BUYER_ID` int(10) NOT NULL AUTO_INCREMENT,
  `AVAILABLE_MONEY` decimal(10,4) DEFAULT NULL,
  `DEPOSITING_MONEY` decimal(10,4) DEFAULT NULL,
  `WITHDRAWING_MONEY` decimal(10,4) DEFAULT NULL,
  `CREATE_BY` varchar(20) DEFAULT NULL,
  `CREATE_TIME` timestamp NULL DEFAULT NULL,
  `LAST_UPDATE_BY` varchar(20) DEFAULT NULL,
  `LAST_UPDATE_TIME` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `waf_wallet_account_fund1` (
  ...
  `LAST_UPDATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `LAST_UPDATE_TIME` timestamp NULL DEFAULT NULL,
  `CURRENCY` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`BUYER_ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
-- ----------------------------
BEGIN;
INSERT INTO `waf_wallet_account_fund1` VALUES (1, 8114.0000, 2000.0000, 100.0000, NULL, NULL, NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `wit_wishlist` (
  ...
  KEY `DSR_ID` (`DSR_ID`),
  KEY `PRO_ID` (`PRO_ID`),
  CONSTRAINT `wit_wishlist_ibfk_1` FOREIGN KEY (`DSR_ID`) REFERENCES `dsr_dropshipper` (`dsr_id`)
...
CREATE TABLE `wta_wallet_transaction_aduit` (
  ...
  `AVAILABLE_MONEY_BEFORE` decimal(10,4) DEFAULT NULL,
  `DEPOSITING_MONEY_BEFORE` decimal(10,4) DEFAULT NULL,
  `WITHDRAWING_MONEY_BEFORE` decimal(10,4) DEFAULT NULL,
  `OPERATE_MONEY` decimal(10,4) DEFAULT NULL,
  `OPERATE_TYPE` tinyint(2) DEFAULT NULL,
  `AVAILABLE_MONEY_AFTER` decimal(10,4) DEFAULT NULL,
  `DEPOSITING_MONEY_AFTER` decimal(10,4) DEFAULT NULL,
  `WITHDRAWING_MONEY_AFTER` decimal(10,4) DEFAULT NULL,
...
CREATE TABLE `wtr_wallet_transaction_record` (
  ...
  `TRANSACTION_NUMBER` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `NOTE` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `OPERATOR_NAME` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `OPERATOR_IP` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CREATE_TIME` timestamp NULL DEFAULT NULL,
  `LAST_UPDATE_BY` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `LAST_UPDATE_TIME` timestamp NULL DEFAULT NULL,
  `BANK_RECEIPT_URL` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `EXCHANGE_RATE` decimal(10,4) DEFAULT NULL,
  `TRANSACTION_DESC` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
